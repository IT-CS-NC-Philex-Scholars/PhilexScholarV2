...
import { AlertCircle, DollarSign, FileStack, GraduationCap, Info, Plus, Save, Trash2, X } from 'lucide-react';
...
export default function Edit({ scholarship }: ScholarshipEditProps) {
            ...
            <AppLayout>
                <div className="flex min-h-[50vh] items-center justify-center">
                    <div className="max-w-md rounded-lg border p-8 text-center">
                        ...
                        <h2 className="mb-2 text-xl font-semibold">Scholarship not found</h2>
    ...
    const { data, setData, put, errors, processing, isDirty } = useForm({
        ...
        available_slots: scholarship.available_slots || 0,
    ...
    const deleteRequirement = (index: number) => {
        ...
        setData(
            ...
            updatedRequirements.filter((req) => !req.isDeleted),
        );
    };

    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title={`Edit: ${scholarship.name || 'Scholarship'}`} />
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <div className="mb-8 flex flex-col justify-between gap-4 md:flex-row md:items-center">
                        <div className="space-y-1">
                            <h1 className="text-2xl font-bold tracking-tight">Edit Scholarship Program</h1>
                            <p className="text-muted-foreground">Manage details, eligibility criteria, and requirements.</p>
                        </div>
                        ...
                        <div className="order-2 space-y-6 lg:order-2 lg:col-span-1">
                                ...
                                <CardContent className="space-y-6">
                                    <div className="bg-muted/50 flex items-center justify-between rounded-lg border p-3">
                                        <div className="space-y-0.5">
                                            ...
                                            <p className="text-muted-foreground text-xs">
                                                {data.active ? 'Scholarship is currently active' : 'Scholarship is inactive'}
                                            </p>
                                        </div>
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <div className="flex gap-2">
                                            <Badge variant={data.active ? 'default' : 'secondary'}>{data.active ? 'Active' : 'Draft/Inactive'}</Badge>
                            ...
                            <div className="rounded-lg border border-blue-100 bg-blue-50 p-4 text-sm text-blue-800 dark:border-blue-800 dark:bg-blue-900/20 dark:text-blue-300">
                                <div className="flex items-start gap-2">
                                    ...
                                    <p>
                                        Changes to eligibility requirements will only affect new applicants. Existing applications remain unchanged.
                                    </p>
                                </div>
                            </div>
                        </div>
                                                                        ...
                                                                        <div className="flex items-center space-x-2 pt-2">
                                                                            <Switch
                                                                                ...
                                                                                onCheckedChange={(value) =>
                                                                                    updateRequirement(index, 'is_required', value)
                                                                                }
                                                                            />
